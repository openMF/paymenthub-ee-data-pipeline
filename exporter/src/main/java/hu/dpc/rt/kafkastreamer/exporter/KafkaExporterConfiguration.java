...
public class KafkaExporterConfiguration {
  // Kafka bootstrap servers. Set it with the broker environment variable
  // ZEEBE_BROKER_EXPORTERS_KAFKA_ARGS_KAFKAURL; the default is the service name
  // used by the Payment Hub Helm charts.
  public String kafkaUrl = "kafka:9092";
